...
//grab settings from the settings.ini file
...
//
//detect mobile browser... If it is mobile, redirect to dependencies/mobi.php
...
//which api am i using?
	...
	{
		echo file_get_contents('http://belowaverage.ga/Who\'sOnline/?'.http_build_query($settings).$QUERY_STRING);
	}
	else
	{
